...
p1= Patient.create!(name: 123, goal: "Stepping", user_id: u1.id)
p2= Patient.create!(name: 456, goal: "Full Gait Cycles", user_id: u3.id)
p3= Patient.create!(name: 650, goal: "Stepping", user_id: u1.id)
p4= Patient.create!(name: 12, goal: "Full Gait Cycles", user_id: u2.id)
p5= Patient.create!(name: 35, goal: "Standing", user_id: u2.id)
p6= Patient.create!(name: 55, goal: "Stepping", user_id: u3.id)
p7= Patient.create!(name: 50, goal: "Full Gait Cycles", user_id: u1.id)
p8= Patient.create!(name: 90, goal: "Full Gait Cycles", user_id: u3.id)
p9= Patient.create!(name: 42, goal: "Full Gait Cycles", user_id: u2.id)
p10= Patient.create!(name: 999, goal: "Full Gait Cycles", user_id: u2.id)
